/**
 * Netlify Function: /.netlify/functions/paystack-init
 *
 * Initializes a Paystack transaction from the server (keeps secret key private).
 *
 * Env vars:
 ...
 * Request JSON:
 * {
 *   "cart": [{"id":"web-design-starter","qty":1}, ...],
